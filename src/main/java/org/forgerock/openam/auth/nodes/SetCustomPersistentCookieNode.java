...
@Node.Metadata(outcomeProvider = SingleOutcomeNode.OutcomeProvider.class,
        configClass = SetCustomPersistentCookieNode.Config.class)
public class SetCustomPersistentCookieNode extends SingleOutcomeNode {

    private static final String BUNDLE = SetCustomPersistentCookieNode.class.getName().replace(".", "/");
     ...
     */
    @Inject
    public SetCustomPersistentCookieNode(@Assisted Config config, @Assisted UUID nodeId) throws NodeProcessException {
        this.config = config;
        this.nodeId = nodeId;
    }
    ...
    public Action process(TreeContext context) throws NodeProcessException {
        logger.debug("SetCustomPersistentCookieNode started");
        logger.debug("Custom persistent cookie set");
        return goToNext()
