 ...
 */
public class CustomPersistentJwtClaimsHandler {
    ...
    private static final String USER_ATTRIBUTES = "openam.attributes";
    ...
    @Inject
    private CustomPersistentJwtClaimsHandler(CoreWrapper coreWrapper) {
     ...
     */
    public Map<String, String> createJwtAuthContext(String orgName, String clientId, String service, String clientIP, Set<String> attributes) {
        ...
        String attibutesString = getAttributes(clientId, orgName, attributes);

        authContext.put(USER_ATTRIBUTES, attibutesString);
        return authContext;
    }

    private String getAttributes(String userName, String realm, Set<String> attributes) {
        ...
        for (String attribute : attributes) {
            ...
            try {
                Set<String> idAttrs = userIdentity.getAttribute(attribute);
                if (idAttrs == null || idAttrs.isEmpty()) {
                    debug.error("[" + DEBUG_FILE + "]: " + "Unable to find attribute: " + attribute);
                } else {
                    String attr = idAttrs.iterator().next();
                    cookieValue.append(attr);
                    cookieValue.append(" ");
                }
